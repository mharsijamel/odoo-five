...
class analytic_report(models.AbstractModel):
    ...
    _name = 'account.analytic.official.report'
        ...
        if account_ids_to_not_display is None:
            self.env.cr.execute(
                ...
                WHERE account.active IS FALSE
                    ...
                    AND account.cost_center != TRUE  -- Add this condition
                """, {
